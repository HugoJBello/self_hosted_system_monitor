...
MIDDLEWARE = [
    ...
    "main_app.middleware.AppSubpathMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "main_app.context_processors.app_shell",
            ],
        },
    },
]
...
FRONTEND_ASSET_VERSION = os.getenv("FRONTEND_ASSET_VERSION", "20260925-video-ready-player")
...
WEB_TERMINAL_IDLE_TIMEOUT_SECONDS = int(os.getenv("WEB_TERMINAL_IDLE_TIMEOUT_SECONDS", "3600"))
