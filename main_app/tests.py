...
class MonitorViewsTests(TestCase):
    ...
    def test_terminal_page_is_staff_only(self):
        ...
        self.assertContains(response, "mobile-focus-anchor")
    ...
    @patch("volumes_app.path_browser.HOST_ROOT_PATH", "/")
    def test_file_manager_information_includes_video_preview_url(self):
        with tempfile.TemporaryDirectory() as tmpdir:
    ...
    @patch("main_app.views.send_json_notification")
