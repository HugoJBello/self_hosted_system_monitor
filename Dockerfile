...
RUN apt-get update \
    && apt-get install -y --no-install-recommends build-essential procps util-linux e2fsprogs xfsprogs btrfs-progs dosfstools exfatprogs ntfs-3g openssh-client rsync sshpass curl ca-certificates libimage-exiftool-perl ffmpeg \
