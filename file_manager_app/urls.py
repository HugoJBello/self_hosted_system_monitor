...
from .views import (
    ...
    FileManagerVideoMetadataView,
    FileManagerCompatibleVideoView,
    FileManagerVideoSubtitleView,
...
urlpatterns = [
    ...
    path("files/video/metadata/", FileManagerVideoMetadataView.as_view(), name="file-manager-video-metadata"),
    path("files/video/compatible/", FileManagerCompatibleVideoView.as_view(), name="file-manager-video-compatible"),
    path("files/video/subtitles/<int:stream_index>/", FileManagerVideoSubtitleView.as_view(), name="file-manager-video-subtitle"),
